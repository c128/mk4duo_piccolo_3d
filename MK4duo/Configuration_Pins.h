...
#if DRIVER_EXTRUDERS > 6                      //modifica 8 estrusori
  #define E6_STEP_PIN   ORIG_E6_STEP_PIN
  #define E6_DIR_PIN    ORIG_E6_DIR_PIN
  #define E6_ENABLE_PIN ORIG_E6_ENABLE_PIN
#endif

#if DRIVER_EXTRUDERS > 7
  #define E7_STEP_PIN   ORIG_E7_STEP_PIN
  #define E7_DIR_PIN    ORIG_E7_DIR_PIN
  #define E7_ENABLE_PIN ORIG_E7_ENABLE_PIN
#endif
